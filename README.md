...
```bash
mvn clean verify
java -jar target/nlipse-0.3.0-SNAPSHOT.jar
```
...
The plot canvas follows the window size; no fixed-resolution or null-layout drawing panel remains.

## Continuous integration

GitHub Actions runs the complete Maven test suite on Java 11, 17 and 21 for every push and pull request.
